...
import 'presentation/controllers/in_app_messaging_controller.dart';
...
Future<void> main() async {
  ...
  final messagingController = InAppMessagingController();
  runApp(
    GreenBiteApp(
...
class GreenBiteApp extends StatelessWidget {
  ...
  final MealPlannerController mealPlannerController;
  final InAppMessagingController messagingController;
