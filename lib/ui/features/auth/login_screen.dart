...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _submit() async {
    ...
    try {
      await context.read<AuthController>().login(_emailController.text, _passwordController.text);
      await context.read<SessionController>().setGuest(false);
      if (!mounted) return;
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text(AppLocalizations.of(context).translate('onboardingLogin'))),
      );
  ...
  Widget build(BuildContext context) {
    ...
    return Directionality(
      ...
      child: Scaffold(
        appBar: AppBar(title: Text(loc.translate('onboardingLogin'))),
              ...
              child: Column(
                children: [
                  ...
                  ElevatedButton(
                    ...
                    child: _isLoading ? const CircularProgressIndicator() : Text(loc.translate('onboardingLogin')),
                  ),
